...
class TelaPrincipal:
    ...
    def create_widgets(self):
        ...
        # #Barra de Rolamento:
        # BarraRolamento = ttk.Scrollbar(Frame_Pecas, orient="vertical")
        # BarraRolamento.place(x = 825, y = 14, height=Frame_Pecas.winfo_height() + 223)  # Ajustando o tamanho da barra de rolagem
        # #Conectando barra com a tabela
        # Frame_Pecas.config(yscrollcommand=BarraRolamento.set)
        # BarraRolamento.config(command=Frame_Pecas.yview)



        Frame1 = ctk.CTkFrame(Frame_Pecas, width=200, height=250, fg_color="WHITE",border_width= 1, border_color="#CCCCCC",corner_radius=0)
        Frame1.place(x = 30,y = 20)  

        Frame2 = ctk.CTkFrame(Frame_Pecas, width=200, height=250, fg_color="WHITE",border_width= 1, border_color="#CCCCCC",corner_radius=0)
        Frame2.place(x = 275,y = 20)  

        Frame3 = ctk.CTkFrame(Frame_Pecas, width=200, height=250, fg_color="WHITE",border_width= 1, border_color="#CCCCCC",corner_radius=0)
        Frame3.place(x = 520,y = 20)  

        Frame4 = ctk.CTkFrame(Frame_Pecas, width=200, height=250, fg_color="WHITE",border_width= 1, border_color="#CCCCCC",corner_radius=0)
        Frame4.place(x = 765,y = 20)  

        Frame5 = ctk.CTkFrame(Frame_Pecas, width=200, height=250, fg_color="WHITE",border_width= 1, border_color="#CCCCCC",corner_radius=0)
        Frame5.place(x = 30,y = 300)  

        Frame6 = ctk.CTkFrame(Frame_Pecas, width=200, height=250, fg_color="WHITE",border_width= 1, border_color="#CCCCCC",corner_radius=0)
        Frame6.place(x = 275,y = 300)  

        Frame7 = ctk.CTkFrame(Frame_Pecas, width=200, height=250, fg_color="WHITE",border_width= 1, border_color="#CCCCCC",corner_radius=0)
        Frame7.place(x = 520,y = 300)  

        Frame8 = ctk.CTkFrame(Frame_Pecas, width=200, height=250, fg_color="WHITE",border_width= 1, border_color="#CCCCCC",corner_radius=0)
        Frame8.place(x = 765,y = 300)  
